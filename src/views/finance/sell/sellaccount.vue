<template>
  <div class="app-container">
    <div class="filter-container">
      <el-input style="width: 180px;" v-model="param.searchCondition.paySerialId" class="filter-item" placeholder="支付单号">
      </el-input>
      <el-date-picker
        v-model="payDate"
        type="daterange"
      ...
      <el-button class="filter-item" @click.native.prevent="getFinanceIncomeList()" type="primary" icon="el-icon-search">搜索</el-button>
        ...
        <div class="cfj">
          ...
          <div class="cfj-cont">
            <div class="clearfix cf-info">
              <div class="item item2">姓名：<span id="detail_patient_name">{{prescriptionRefundDetail.patient.name }}</span>
              </div>
              <div class="item item2">性别:<span
                id="detail_patient_sexName">{{ prescriptionRefundDetail.patient.sexName }}</span></div>
              <div class="item item2">年龄：<span id="detail_patient_age">{{ prescriptionRefundDetail.patient.age }}</span></div>
              <div class="item item2">手机号：<span id="detail_patient_tel">{{ prescriptionRefundDetail.patient.tel }}</span>
              </div>
