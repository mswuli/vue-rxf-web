<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="departName" label="科室"></el-table-column>
      <el-table-column prop="docName" width="120" label="医生"></el-table-column>
      <el-table-column prop="code" width="110" label="处方编号"></el-table-column>
      <el-table-column prop="prescriptionTotalAmount" width="80" label="处方总金额（元）"></el-table-column>
      <el-table-column prop="diagnosticAmount" width="80" label="诊查费（元）"></el-table-column>
      <el-table-column prop="finalAmount" width="80" label="实付金额（元）"></el-table-column>
...
export default {
  ...
  computed: mapState({
    prescriptions: state => state.prescription.prescriptions,
  ...
  methods: {
    getPrescriptionList() {
      ...
      this.$store.dispatch('getPrescriptionList', { params: this.param, callback: () => {
    ...
    detail(row) {
      ...
      this.$store.dispatch('getPrescriptionDetail', { params: row, callback: () => {
    ...
    showShDetail(row) {
      ...
      this.$store.dispatch('getPrescriptionShDetail', { params: shObject, callback: () => {
